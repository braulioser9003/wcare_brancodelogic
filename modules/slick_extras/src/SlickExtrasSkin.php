  ...
  public function skins() {
    ...
    $skins = [
      'd3-back' => [
        ...
        'css' => [
          'theme' => [
            'modules/slick_extras/css/theme/slick.theme--d3-back.css' => [],
          ],
        ],
      ...
      'boxed' => [
        ...
        'css' => [
          'theme' => [
             'modules/slick_extras/css/theme/slick.theme--boxed.css' => [],
          ],
        ],
      ],
      'boxed-carousel' => [
        ...
        'css' => [
          'theme' => [
             'modules/slick_extras/css/theme/slick.theme--boxed.css' => [],
            'modules/slick_extras/css/theme/slick.theme--boxed--carousel.css' => [],
          ],
        ],
      ],
      'boxed-split' => [
        ...
        'css' => [
          'theme' => [
            'modules/slick_extras/css/theme/slick.theme--boxed.css' => [],
             'modules/slick/css/theme/slick.theme--split.css' => [],
          ],
        ],
      ],
      'rounded' => [
        ...
        'css' => [
          'theme' => [
             'modules/slick_extras/css/theme/slick.theme--rounded.css' => [],
          ],
        ],
      ],
      'vtabs' => [
        ...
        'css' => [
          'theme' => [
             'modules/slick_extras/css/theme/slick.theme--vtabs.css' => [],
          ],
        ],
      ],
    ];
